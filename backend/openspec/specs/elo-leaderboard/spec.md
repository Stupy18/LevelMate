# elo-leaderboard Specification

## Purpose
Expose a top-50 leaderboard per sport ordered by ELO rating, so users can see
where they rank among all players of a sport on the platform.

## Requirements

### Requirement: Sport leaderboard returns top 50 players by ELO
The system SHALL expose a leaderboard returning the top 50 users by ELO rating for a given sport, ordered descending.
