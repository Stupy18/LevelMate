# elo-calculation Specification

## Purpose
Asynchronously recalculate ELO ratings for all participants after a game result is CONFIRMED.
Uses a two-layer formula: team averages determine outcome magnitude; individual ELO vs opposing
team average determines each player's personal delta. Applies only to ELO_COMPETITIVE sports.
