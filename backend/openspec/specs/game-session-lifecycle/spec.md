# game-session-lifecycle Specification

## Purpose
Allow authenticated users to create, retrieve, and search game sessions. Hosts can cancel or mark sessions as completed.
